			...
			<?php if ($d['PelangganID'] == $PelangganID) { ?>
				...
				<?php 
					...
					<div class="row">
						...
						<div class="col-sm-2">
							<div class="form-group">
								<button class="btn btn-info btn-sm form-control" id="bayar">Bayar</button>
							</div>
						</div>
					</div>
				<!-- </form> -->
        ...
        <form method="post" action="simpan_total_harga.php">
				...
				<?php 
					...
					<div class="row">
						<div class="col-sm-10">
							<div class="form-group">
								<input type="text" class="form-control" name="kembalian" onchange="this.setAttribute('value', this.value)">
								<input type="text" name="PelangganID" value="<?php echo $d['PelangganID']; ?>" hidden>
								<input type="text" name="PenjualanID" value="<?php echo $d['PenjualanID']; ?>" hidden>
							</div>
						</div>
